...
3. Report the created path. Remind the user to fill in the title, description, and acceptance criteria into the generated `intake.md` before running `/squad-plan`.