...
- **Meta-prompt:** `generate-plan.md` from the **installed squad-kit package**. Locate it at:
  - Windows: `%APPDATA%\npm\node_modules\squad-kit\templates\prompts\generate-plan.md`
  - Or run: `squad new-plan <intake> --copy` to print the composed meta-prompt.
  Follow it exactly.
